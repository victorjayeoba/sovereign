...
/**
 * Animated wave field — Perlin-noise mesh that responds to cursor velocity.
 * Adapted from React Bits (Waves-JS) and retuned for the Sovereign palette:
 * thin cyan lines on absolute black.
 *
 * Render this as the first child of a `position: relative` container.
 */
...
export default function Waves({
  ...
  useEffect(() => {
    ...
    const moved = (point: Pt, withCursor = true) => ({
    ...
    // Container can resize independently of the window (font loads, content
    // mounting, parent layout shifts). Watch it so the canvas doesn't get
    // stuck at the initial bounding-rect.
